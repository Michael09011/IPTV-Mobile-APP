  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `channels` (`id` TEXT NOT NULL, `playlistId` TEXT NOT NULL, `name` TEXT NOT NULL, `thumbnail` TEXT, `category` TEXT NOT NULL, `currentProgram` TEXT, `isFavorite` INTEGER NOT NULL, `streamUrl` TEXT NOT NULL, `resolution` TEXT NOT NULL, PRIMARY KEY(`id`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '483e52e0d1574e53b0d54d130ca27e12')");
      }
    ...
    }, "483e52e0d1574e53b0d54d130ca27e12", "f5259625c6ec2a062e201a6840ca78db");
